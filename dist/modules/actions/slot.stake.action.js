...
exports.SlotStakeActions = void 0;
...
class SlotStakeActions extends actions_class_1.default {
        ...
        this.bot.action(`${ru_json_1.default.buttons.stake.max}slot`, (ctx) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                switch (status) {
                    ...
                    case "real":
                        text = `${ru_json_1.default.main.real} ${user.balance}💸\n\n${ru_json_1.default.main.slots.stake}`;
                        newStake = yield this.redis.setStake(id, user.balance <= 1000 ? user.balance : 1000);
                        break;
                    default:
                        return;
                }
...
exports.SlotStakeActions = SlotStakeActions;
