...
class StartActions extends actions_class_1.default {
    ...
    handler() {
        ...
        this.bot.action(ru_json_1.default.buttons.wallet, (ctx) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.redis.checkAction(ctx.from.id, ctx);
                const { id, first_name, username } = ctx.from;
                const user = yield this.db.getUser(String(id), username, first_name);
                yield ctx.deleteMessage();
                const message = yield ctx.replyWithHTML(`${ru_json_1.default.main.balance.start}${user.balance} ${ru_json_1.default.main.balance.real}${user.demo} ${ru_json_1.default.main.balance.demo}`, {
