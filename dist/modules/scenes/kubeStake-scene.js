...
class CubeStakeScene extends scenes_class_1.default {
    constructor(redis, db) {
        super(redis, db);
        this.bot = new telegraf_1.Scenes.BaseScene("CubeStake");
    }
    init() {
            ...
            try {
                ...
                switch (status) {
                    case "demo":
                        ...
                        break;
                    case "real":
                        text = `${ru_json_1.default.main.balance} ${user.balance}💸\n\n${ru_json_1.default.main.slots.stake}`;
                        break;
                    default:
                        return;
                }
                ...
                if (action) {
                    yield ctx.editMessageText(`${text}`, {
                        reply_markup: this.keyboardService.cube(newStake, status),
                        // @ts-ignore
                        chat_id: ctx.chat.id,
...
exports.default = CubeStakeScene;
