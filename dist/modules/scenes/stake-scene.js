...
class StakeScene extends scenes_class_1.default {
    constructor(redis, db) {
        super(redis, db);
        this.bot = new telegraf_1.Scenes.BaseScene("stake");
    }
    init() {
        this.bot.hears(/\b([5-9]|[1-9][0-9]|[1-9][0-9]{2}|1000)\b/, (ctx) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (newStake > user.demo)
                    return;
                if (action) {
                    yield ctx.editMessageText(`${ru_json_1.default.main.сube.demo} ${user.demo}🍬\n\n${ru_json_1.default.main.stake}`, {
